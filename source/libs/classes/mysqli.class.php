...
final class db_mysqli {
	...
	public function connect() {
		$port = isset($this -> config['port']) ? intval($this -> config['port']) : 3306;
		$this -> link = new mysqli($this -> config['hostname'], $this -> config['username'], $this -> config['password'], $this -> config['database'], $port);
	...
	public function halt($message = '', $sql = '') {
		...
		$log = date('Y-m-d H:i:s') . " SQL Error: " . $this->error() . " | SQL: " . $sql . "\n";
		file_put_contents('/www/wwwroot/caipiaofile/sql_error.log', $log, FILE_APPEND);
