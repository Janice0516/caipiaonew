	...
	<form enctype="multipart/form-data" action="<?php echo ADMIN_PATH?>&c=settings&a=init" method="post" id="myform">
			...
			<table width="100%" cellspacing="0" class="table_form">
				<tbody>
					...
					<tr style="display:none">
						<th>隐藏汇率字段 (Deprecated)：</th>
						<td>
						   <input type="hidden" name="setting[hbname1]" value="<?php echo $hbname1;?>">   
						   <input type="hidden" name="setting[hbname3]" value="<?php echo $hbname3;?>">   
						   <input type="hidden" name="setting[hblv3]" value="<?php echo $hblv3;?>">
						   <input type="hidden" name="setting[hbname4]" value="<?php echo $hbname4;?>">   
						   <input type="hidden" name="setting[hblv4]" value="<?php echo $hblv4;?>">
						   <input type="hidden" name="setting[hbname5]" value="<?php echo $hbname5;?>">   
						   <input type="hidden" name="setting[hblv5]" value="<?php echo $hblv5;?>">
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div id="content-2" style="display:none;">
            ...
            <tr>
            	...
            	<tr>
						<th>首充优惠活动标题：</th>
						<td>
							<input class="input-text" type="text" name="setting[firstRechargetitle]" style="width: 500px;" value="<?php echo $firstRechargetitle;?>">
						 
						</td>
					</tr>
             	<tr>
				<th width="100"></th>
				<td><?php echo $firstRechargead ? '<img src="uppic/ewm/'.$firstRechargead.'" width="200" height="200" />' : ''?></td>
			</tr>
					<tr>
				<th width="100">首充优惠活动图片：</th>
				<td>
					<input type="file" id="firstRechargead" name="firstRechargead" accept="image/*" />
					<input type="hidden" id="firstRechargead_old" name="setting[firstRechargead_old]" value="<?= $firstRechargead ?>"/>
					<span> 图片尺寸：300PX * 100PX</span>
				</td>
			</tr>
			<tr>
						<th>首冲优惠活动时间：</th>
						<td>
							<input class="input-text date" type="text" name="setting[firstRecharge_start_time]" id="firstRecharge_start_time" value="<?php echo $firstRecharge_start_time;?>" size="51"  placeholder="开始时间">
							<input class="input-text date" type="text" name="setting[firstRecharge_end_time]" id="firstRecharge_end_time" value="<?php echo $firstRecharge_end_time;?>" size="51"  placeholder="结束时间">
            ...
            <tr>
            	...
            	<tr>
						<th>每日首冲优惠活动标题：</th>
						<td>
							<input class="input-text" type="text" name="setting[dayFirstRechargetitle]" style="width: 500px;" value="<?php echo $dayFirstRechargetitle;?>">
						 
						</td>
					</tr>
            <tr>
				<th width="100"></th>
				<td><?php echo $dayFirstRechargead ? '<img src="uppic/ewm/'.$dayFirstRechargead.'" width="200" height="200" />' : ''?></td>
			</tr>
					<tr>
				<th width="100">每日首冲优惠活动图片：</th>
				<td>
					<input type="file" id="dayFirstRechargead" name="dayFirstRechargead" accept="image/*" />
					<input type="hidden" id="dayFirstRechargead_old" name="setting[dayFirstRechargead_old]" value="<?= $dayFirstRechargead ?>"/>
					<span> 图片尺寸：300PX * 100PX</span>
				</td>
			</tr>
			<tr>
						<th>每日首冲优惠活动时间：</th>
						<td>
							<input class="input-text date" type="text" name="setting[dayFirstRecharge_start_time]" id="dayFirstRecharge_start_time" value="<?php echo $dayFirstRecharge_start_time;?>" size="51"  placeholder="开始时间">
							<input class="input-text date" type="text" name="setting[dayFirstRecharge_end_time]" id="dayFirstRecharge_end_time" value="<?php echo $dayFirstRecharge_end_time;?>" size="51"  placeholder="结束时间">
            ...
            <tr>
            	...
            	<tr>
						<th>每次充值优惠活动标题：</th>
						<td>
							<input class="input-text" type="text" name="setting[rechargetitle]" style="width: 500px;" value="<?php echo $rechargetitle;?>">
						 
						</td>
					</tr>
            <tr>
				<th width="100"></th>
				<td><?php echo $rechargead ? '<img src="uppic/ewm/'.$rechargead.'" width="200" height="200" />' : ''?></td>
			</tr>
					<tr>
				<th width="100">每次充值优惠活动图片：</th>
				<td>
					<input type="file" id="rechargead" name="rechargead" accept="image/*" />
					<input type="hidden" id="rechargead_old" name="setting[rechargead_old]" value="<?= $rechargead ?>"/>
					<span> 图片尺寸：300PX * 100PX</span>
				</td>
			</tr>	<tr>
						<th>每次充值优惠活动时间：</th>
						<td>
							<input class="input-text date" type="text" name="setting[recharge_start_time]" id="recharge_start_time" value="<?php echo $recharge_start_time;?>" size="51"  placeholder="开始时间">
							<input class="input-text date" type="text" name="setting[recharge_end_time]" id="recharge_end_time" value="<?php echo $recharge_end_time;?>" size="51"  placeholder="结束时间">
		...
		<div id="content-3" style="display:none;">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<span>单位：元（存储口径，可填三位小数），全局生效</span>
						</td>
					</tr>
					<tr>
						<th>最低提现金额：</th>
					...
					<tr>
						...
						<td>
							...
							<span>全局生效，可填写百分比如：5%（按提现金额比例计算），或填写固定手续费（单位：元，可填三位小数）</span>
						</td>
					</tr>
					<tr>
						<th>单笔提现上限：</th>
					...
					<tr>
						...
						<td>
							...
							<span>单位：元（存储口径，可填三位小数），全局生效，格式：0.001-50000.000</span>
						</td>
					</tr>
			<tr style="display:none">
				<th width="100"></th>
			...
			<tr>
				<th>USDT 收款地址：</th>
				<td>
					<input class="input-text" type="text" name="setting[hbname2]" value="<?php echo $hbname2;?>" style="width: 350px;" />
					<span>数字货币(TRC20)地址，将展示在充值页面供会员复制</span>
				</td>
			</tr>
			<tr>
				<th>USDT 汇率设置：</th>
				<td style='line-height:30px;'>
					充值汇率：<input class="input-text" type="text" name="setting[hblv1]" value="<?php echo $hblv1;?>" size="10"> (1 USDT = N RMB) <br/>
					提现汇率：<input class="input-text" type="text" name="setting[hblv2]" value="<?php echo $hblv2;?>" size="10"> (1 USDT = N RMB)
				</td>
			</tr>
			<tr>
				<th>收款银行：</th>
