...
<div class="content-t">
    ...
    <em>可用</em>
    <span><?php echo money_fmt(money_from_yuan($data['money'], $unit)).$unit_label?></span>
    <em>投注|盈亏</em>
    <span><?= money_fmt(money_from_yuan($order_count['money'], $unit)).$unit_label ?>|<?= money_fmt(money_from_yuan($order_count['account'], $unit)).$unit_label ?></span>
	...
	<div class="uname">
		...
		<em>今日盈亏</em>
    <span><?= money_fmt(money_from_yuan($day_order_count['account']-$day_order_count['money'], $unit)).$unit_label ?></span>
    	<em>今日投注总额</em>
    <span><?= $day_order_count['money'] ? money_fmt(money_from_yuan($day_order_count['money'], $unit)).$unit_label : '0.000'.$unit_label ?></span>
	    <em>本周投注总额</em>
    <span><?= $week_order_count['money'] ? money_fmt(money_from_yuan($week_order_count['money'], $unit)).$unit_label : '0.000'.$unit_label ?></span>
	</div>
