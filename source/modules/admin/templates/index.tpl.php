...
<div id="content" class="content-on">
	<div class="col-left left_menu">
		<ul>
			...
			<li class="menuli" onclick="menu_show(this);"><a hidefocus="true" style="outline:none" href="<?php echo ADMIN_PATH?>&c=bot" target="right_iframe"><i class="icon-4"></i>底层发号风控</a></li>
			<li class="menuli" onclick="menu_show(this);"><a hidefocus="true" style="outline:none" href="<?php echo ADMIN_PATH?>&c=bot_template" target="right_iframe"><i class="icon-4"></i>官方机器人模板</a></li>
			<?php }?>
			<div class="line-x"></div>
			...
			<div class="line-x"></div>
			<li class="menuli" onclick="menu_show(this);"><a hidefocus="true" style="outline:none" href="<?php echo ADMIN_PATH?>&c=activity" target="right_iframe"><i class="icon-2"></i>活动管理</a></li>
			<div class="line-x"></div>
