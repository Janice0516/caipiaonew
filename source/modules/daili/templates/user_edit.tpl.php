	...
	<form action="<?php echo DAILI_PATH?>&c=user&a=edit&uid=<?php echo $uid?>" method="post" id="myform">
		<table width="100%" class="table_form">
			...
			<tr>
				<th>返点/赔率：</th>
				<td>
					<input class="input-text" type="text" name="rebate" value="<?php echo $data['rebate'] > 0 ? $data['rebate'] : 1996 ?>" id="rebate" style="width: 100px;" />
					<span>请输入奖金组数值（如1990），不能超过您的当前等级</span>
				</td>
			</tr>
			<tr>
				<th>新密码：</th>
